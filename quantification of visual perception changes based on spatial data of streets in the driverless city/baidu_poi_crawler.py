# -*- coding: utf-8 -*-
"""
Created on Sat May  8 10:13:52 2021
...
poi_config_para={
    ...
    'bound_coordinate':{'leftBottom':[108.941434,34.240036],'rightTop':[108.95878,34.275176]}, #Baidu map coordinate pickup system  http://api.map.baidu.com/lbsapi/getpoint/index.html
...
if __name__=="__main__":
    ...
    save_path={'geojson':'./processed data/poiAll_gpd.geojson','shp':'./processed data/poiAll_gpd.shp','pkl':'./processed data/poiAll_gpd.pkl'} #分别存储为GeoJSON、Shapefile和pickle三种数据格式
    poi_gpd=poi_csv2GeoDF_batch(poi_paths,fields_extraction,save_path)
    poi_gpd=poi_gpd.reset_index()
    gpd2postSQL(poi_gpd,table_name='poi',myusername='postgres',mypassword='123456',mydatabase='streetscape_GSV') 
